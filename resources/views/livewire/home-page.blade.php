<div>
	...
	<div class="jumbotron-container">
		<div class="jumbotron-left">
			...
			<p>We are focused on providing clients with the highest level<br>
					...
					<a href="/book" class="btn btn-fill btn-large">Book Now</a>
		</div>
		<div class="jumbotron-right">
			<form action="" class="jumbotron-form">
				<!-- Put the form here -->
					...
					<input type="text" id="guests" name="guests" placeholder="Number of Guests"><br>
					<label class="hide" for="children">children</label>
					<input type="text" id="children" name="children" placeholder="Number of Children"><br>
	...
	<section class="special-offers">
		...
		<div class="page-header-container">
		  ...
		  <h2 class="page-header">Most Reserved <br>Room</h2>
